...
function AppHeader(param) {
    let { user, showMenuButton, onMenuClick } = param;
...
"[project]/components/layout/sidebar-nav.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SidebarNav(param) {
    let { currentPath, desktop, mobileOpen, plannerHref, onCloseMobile, onSignOut } = param;
    const items = [
        {
            key: "planner",
            label: "Planner",
        ...
        },
        {
            ...
            label: "Activity",
            href: "/activity",
            icon: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$icons$2d$material$2f$esm$2f$EventNote$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                fontSize: "small"
            }, void 0, false, {
                fileName: "[project]/components/layout/sidebar-nav.tsx",
                lineNumber: 41,
    ...
    if (desktop) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Drawer$2f$Drawer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Drawer$3e$__["Drawer"], {
            ...
            PaperProps: {
                sx: {
                    width: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mui$2d$theme$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["drawerWidth"],
...
"[project]/lib/use-responsive-nav.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useResponsiveNav() {
    ...
    const desktopMatch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$useMediaQuery$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__useMediaQuery$3e$__["useMediaQuery"])(theme.breakpoints.up("lg"));
...
_s(useResponsiveNav, "8dtvs8O6ARLmGlshLqf2/bXmilU=", false, function() {
    return [
...
"[project]/services/api-client.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const API_BASE_URL = (_process_env_NEXT_PUBLIC_API_BASE_URL = ("TURBOPACK compile-time value", "http://localhost:8000")) !== null && _process_env_NEXT_PUBLIC_API_BASE_URL !== void 0 ? _process_env_NEXT_PUBLIC_API_BASE_URL : "http://localhost:8000";
class ApiError extends Error {
    constructor(status, message, code){
        super(message), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "status", void 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "code", void 0);
        this.status = status;
        this.code = code !== null && code !== void 0 ? code : undefined;
    }
}
async function parseResponse(response) {
    ...
    if (!response.ok) {
        var _body_code;
        throw new ApiError(response.status, body.message || "Request failed", (_body_code = body.code) !== null && _body_code !== void 0 ? _body_code : null);
    }
    return body;
}
async function apiGet(path) {
    const response = await fetch("".concat(API_BASE_URL).concat(path), {
        method: "GET",
        credentials: "include"
    });
...
async function login(email, password) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiPost"])("/api/auth/login", {
        email,
        password
    });
}
async function logout() {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiPost"])("/api/auth/logout");
}
async function me() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiGet"])("/api/auth/me");
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$layout$2f$sidebar$2d$nav$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/layout/sidebar-nav.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mui$2d$theme$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/mui-theme.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$use$2d$responsive$2d$nav$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/use-responsive-nav.ts [app-client] (ecmascript)");
...
function AppShell(param) {
    ...
    const nav = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$use$2d$responsive$2d$nav$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useResponsiveNav"])();
    var _pathname_match_;
    const activeYear = (_pathname_match_ = (_pathname_match = pathname.match(/^\/years\/(\d{4})$/)) === null || _pathname_match === void 0 ? void 0 : _pathname_match[1]) !== null && _pathname_match_ !== void 0 ? _pathname_match_ : "2026";
    const [plannerYear, setPlannerYear] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(activeYear);
    const plannerHref = "/years/".concat(plannerYear);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppShell.useEffect": ()=>{
    ...
    async function handleLogout() {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logout"])();
        nav.closeMobileNav();
        router.push("/login");
        router.refresh();
    }
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$layout$2f$sidebar$2d$nav$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SidebarNav"], {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
                ...
                sx: {
                    ...
                    minWidth: 0,
                    ml: {
                        lg: "".concat(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mui$2d$theme$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["drawerWidth"], "px")
                    }
                },
                children: [
...
_s(AppShell, "AZeMIrHH+01gx+p/W6nkUY8zMT8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$use$2d$responsive$2d$nav$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useResponsiveNav"]
    ];
});
_c = AppShell;
var _c;
...
"[project]/services/session.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getCurrentUser() {
    try {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiGet"])("/api/auth/me");
    } catch (e) {
        return null;
    }
}
...
"[project]/app/(authenticated)/layout.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/session.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function AuthenticatedLayout(param) {
    ...
    const sessionQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCurrentUser"],
        retry: false,
        staleTime: 5 * 60_000
    });
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthenticatedLayout.useEffect": ()=>{
            endTimingRef.current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$performance$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startRouteTiming"])("/authenticated-shell");
            return ({
                "AuthenticatedLayout.useEffect": ()=>{
...
_s(AuthenticatedLayout, "Idwg0WOA94hjJHYQHSdLInL8gno=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=_8cdfe118._.js.map